...
Air.O3.NC18 <-read.csv(file=here("./Data/Raw/EPAair_O3_NC2018_raw.csv"), stringsAsFactors = TRUE)
Air.O3.NC19 <- read.csv(file=here("./Data/Raw/EPAair_O3_NC2019_raw.csv"), stringsAsFactors = TRUE)

Air.PM25.NC18 <-read.csv(file=here("./Data/Raw/EPAair_PM25_NC2018_raw.csv"), stringsAsFactors = TRUE)
Air.PM25.NC19 <-read.csv(file=here("./Data/Raw/EPAair_PM25_NC2019_raw.csv"), stringsAsFactors = TRUE)
...
```{r}
#3 Glimpse showed us the date col was in 2 digit month, 2 digit day, and 4 digit year format
