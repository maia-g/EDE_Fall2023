...
write.csv(Air.O3.NC18.processed, row.names = FALSE, file = "./Data/Processed/EPAair_O3_NC2018_processed.csv")
write.csv(Air.O3.NC19.processed, row.names = FALSE, file = "./Data/Processed/EPAair_O3_NC2019_processed.csv")

write.csv(Air.PM25.NC18.processed, row.names = FALSE, file = "./Data/Processed/EPAair_PM25_NC2018_processed.csv")
write.csv(Air.PM25.NC19.processed, row.names = FALSE, file = "./Data/Processed/EPAair_PM25_NC2019_processed.csv")
...
Air.Combo.Subset <-
  Air.Combo %>%
  filter(Site.Name %in% c("Durham Armory", "Leggett", 
...
###ISSUE: I'm somehow getting 14,125 observations of 9 vars instead of 14,752??
...
Air.Summary <-
  ...
  ###ISSUE: output says summarise grouped by only the first two things?
