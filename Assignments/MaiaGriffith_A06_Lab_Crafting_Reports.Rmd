...
```{r Ozone 2018, echo=FALSE, warning=FALSE, fig.height = 4, fig.width = 6, fig.align='left', fig.cap= 'Monthly Ozone, 2018'}
Oz18_plot <-
  epa_data %>%
  ...
  ggplot(aes(x = factor(Month,
             ...
             y = Ozone)) +
  geom_boxplot() +
  labs(title = "Recorded Ozone by Month (2018)",
...
```{r Ozone 2019, echo=FALSE, warning=FALSE, fig.height = 4, fig.width = 6, fig.align= 'left', fig.cap= 'Monthly Ozone, 2019'}
Oz19_plot <-
  epa_data %>%
  ...
  ggplot(aes(x = factor(Month,
             ...
             y = Ozone)) +
  geom_boxplot() +
  labs(title = "Recorded Ozone by Month (2019)",
       y =expression(paste("Ozone ","(", mu, g/m^{3}, ")")), #Making the symbols
       x = "Month") +
  scale_x_discrete(name = "Month", drop = FALSE) +
  theme(axis.text.x = element_text(angle = 45,  hjust = 1))
