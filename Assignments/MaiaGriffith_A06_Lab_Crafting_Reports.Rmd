...
```{r Ozone 2018, echo=FALSE, warning=FALSE, fig.height = 4.5, fig.width = 6, fig.align='left', fig.cap= 'Ozone Levels by Month (2018)'}
Oz18_plot <-
  epa_data %>%
  ...
  ggplot(aes(x = factor(Month,
             ...
             y = Ozone)) +
  geom_boxplot() +
  labs(y =expression(paste("Ozone ","(", mu, g/m^{3}, ")")), #Making the symbols
       x = "Month") +
...
```{r Ozone 2019, echo=FALSE, warning=FALSE, fig.height = 4.5, fig.width = 6, fig.align= 'left', fig.cap= 'Ozone Levels by Month (2019)'}
Oz19_plot <-
  epa_data %>%
