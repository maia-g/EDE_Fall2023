...
tp_po4_plot <- 
  ...
  labs(title = "Total Phosphorous vs Phosphate in Peter and Paul Lakes",
       x = "Phosphate (PO4)",
       y = "Total Phosphorous") +
      # legend.title = "Name of Lake")+ ####ISSUE: How to change the freaking legend title??
 # theme(legend.title = element_text("Name of Lake"))
...
TP_box <-
  ...
  labs(title = "Total Phosphorous by Month",
       y = "Total Phosphorous") + ###ISSUE: How to get ug in this? The only example is using expression for geom_text
 # theme(legend.position = "none") +
