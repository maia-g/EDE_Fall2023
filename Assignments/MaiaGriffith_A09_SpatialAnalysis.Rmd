...
NE_site_flow <- read.csv("Data/Raw/NWIS_SiteFlowData_NE_RAW.csv", 
                         colClasses = c('station_nm' = 'factor', 
                                        'date' = 'factor')) ### HHOW TO KNOW WHAT FIELDS TO MAKE FACTORS OR NOT??

#15. Show the column names
colnames(NE_site_flow) ### WHY DON'T ALL THE FIELDS SHOW WHEN IMPORTING?
...
mapView(NEcounties_sf_utm, col.regions = "gray") +
  mapView(NEgageflow_sf_join_utm)
###I FEEL LIKE MY MAPS LOOK THE SAME?? COMPARE 21 WITH 19
