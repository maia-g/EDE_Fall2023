...
```{r Q1-Importing Data,  message = FALSE}
...
```{r Q6- Most Commonly Studied Effects}
...
```{r Q7- Most Commonly Studied Species}
...
```{r Q10- Studies per Year by Location}
...
```{r Q12- Changing Dates in Litter}
...
```{r Q14- Types of Litter Collected}
