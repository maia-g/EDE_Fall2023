...
###QUESTION: Should I be changing this in the dataframe Litter or is it ok to create a new vector? I tried to use the lubridate ymd() function on the dataframe itself but it did not change the class to Date.
#ymd(Litter$collectDate)

lit_collectDate_str <- (Litter$collectDate)
lit_collectDate_str

lit_collectDate_DATE <- ymd(lit_collectDate_str)
lit_collectDate_DATE

#Check to see if it changed.
class(lit_collectDate_DATE) #this vector is now a Date class.

#Using the `unique` function.
unique(lit_collectDate_DATE) #shows Aug 2nd and 30th were sample dates.
