...
ggplot(USGS.flow.data) + #supplying data
  ...
  geom_freqpoly(aes(x = gage.height.min), bins = 50, color = "red") + #changes color
...
#taking diff slices of data and looking at the dist which is done with the 'group' command. sorta like a histogram but instead of counts we are looking at distribution of values within th ebins
ggplot(USGS.flow.data) +
